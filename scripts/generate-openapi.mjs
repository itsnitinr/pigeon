...
const spec = {
  ...
  info: {
    ...
    version: '0.1.0',
    description:
      'Pigeon Notifications API for sending, listing, streaming, and mutating end-user notifications.'
  },
  servers: [
    {
  ...
  components: {
    securitySchemes: {
      ApiKeyAuth: {
        type: 'http',
        scheme: 'bearer',
        description: 'Use a Pigeon API key, e.g. pk_test_xxx or pk_live_xxx.'
      },
      UserJwtAuth: {
        type: 'http',
        scheme: 'bearer',
        description: 'JWT minted by POST /v1/users/{userId}/token.'
      }
    },
    schemas: {
      ErrorResponse: {
      ...
      NotificationItem: {
        ...
        required: ['id', 'userId', 'type', 'title', 'status', 'createdAt']
      },
  ...
  paths: {
              ...
              'application/json': {
                schema: {
                  ...
                  properties: {
                    ...
                    service: { type: 'string', example: 'pigeon-api' },
    ...
    '/v1/notifications': {
      post: {
        ...
        responses: {
          ...
          '200': {
            description: 'Idempotent replay hit existing notification',
            content: {
              'application/json': {
                schema: { $ref: '#/components/schemas/SendNotificationResponse' }
              }
      ...
      get: {
        tags: ['Notifications'],
        summary: 'List notifications for authenticated end-user',
        ...
        responses: {
          ...
          '401': {
            description: 'Invalid/expired JWT',
            content: {
              'application/json': { schema: { $ref: '#/components/schemas/ErrorResponse' } }
            }
          }
    ...
    '/v1/users/{userId}/token': {
      post: {
        tags: ['Auth'],
        summary: 'Create user JWT for frontend SDK',
        security: [{ ApiKeyAuth: [] }],
        parameters: [
          {
            name: 'userId',
        ...
        requestBody: {
          ...
          content: {
            'application/json': {
              schema: { $ref: '#/components/schemas/CreateUserTokenRequest' }
            }
          }
        },
        responses: {
          '201': {
            ...
            content: {
              'application/json': {
                schema: { $ref: '#/components/schemas/CreateUserTokenResponse' }
              }
            }
          },
          '400': {
      ...
      post: {
        ...
        responses: {
          '200': {
            ...
            content: {
              'application/json': {
                schema: { $ref: '#/components/schemas/MarkReadResponse' }
              }
            }
          }
        }
    ...
    '/v1/notifications/read-all': {
      post: {
        ...
        responses: {
          '200': {
            description: 'Bulk read operation result',
            content: {
              'application/json': {
    ...
    '/v1/stream': {
      get: {
        tags: ['Realtime'],
        summary: 'Subscribe to realtime notification events (SSE)',
        description:
          'EventSource stream. Supports replay via Last-Event-ID header when reconnecting.',
        security: [{ UserJwtAuth: [] }],
        responses: {
          '200': {
